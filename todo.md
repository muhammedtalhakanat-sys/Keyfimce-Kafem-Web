...
- [ ] Sayfa, modal, yönetim paneli, form, kart, rozet ve alt gezinme alanlarında açık/koyu tema metin-kontrast tokenlarını tek bir okunabilir sistemde birleştir.
- [ ] GitHub başarılı yazma mesajını gerçek Pages/CDN yayını, commit ve canlı dosya doğrulamasıyla eşleştir; diğer cihazların eski katalog görmesini cache/version kontrolüyle gider.
- [ ] Çoklu cihaz ve tema regresyonlarını test edip düzeltmeyi GitHub `main` dalına gönder.
